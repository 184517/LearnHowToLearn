...
function generateStepByStep_() {
  ...
  var headers = [
    [sheetTitle, '', ''],
    ['Step', 'Distance (Meters)', 'Distance (kilometers)']
  ];
  var newRows = [];
  ...
  directionsSheet.getRange(headers.length + 1, 3, newRows.length, 1)
      .setFormulaR1C1('=KILOMETERSTOMILES(R[0]C[-1])');
...
/**
* I attempted to change the unit of miles to kilometers. 
* If it worked, I was hoping that it would convert meters to kilometers.
* I change any mention of miles to kilometers but i must have missed a portion of the program that controbutes to this
**/
